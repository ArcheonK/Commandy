 ...
 * ************************************************************************
 */
public class MotdCommand extends CommandyCommand {

    public MotdCommand(Commandy plugin, String description, String permission, int minimumArgs, String usage, boolean requirePlayer) {
    ...
    public void execute(CommandSender sender, Command command, String label, String[] args) {
        ...
        getPlugin().sendMotd((Player) sender);
